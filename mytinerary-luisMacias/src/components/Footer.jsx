...
export default function Footer(){
    return(
        <div className="h[10vh] lg:flex flex  flex-col md:flex md:justify-between  md:flex-row lg:flex-row lg:justify-between bg-gray-900">


            <div className='p-5 flex flex-col text-white justify-center '> 
