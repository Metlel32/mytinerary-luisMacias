        ...
        <>
            ...
            <div className="flex flex-col w-full justify-center bg-indigo-100 ">
                ...
                <div className='flex justify-center w-full'>
                    <input type="text" className=" w-50 bg-blue-300/50 m-10 rounded-xl p-2 border-2 " placeholder="Search city" />
                </div>
                <div className='p-5 w-full flex flex-wrap justify-evenly '>



                    {cities.map((city) =><Card key={city.id} name={city.name} image={city.images} country={city.country} />)}
